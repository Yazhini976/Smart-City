      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(module.icon, color: module.accentColor, size: 22),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [module.bgColorStart, module.bgColorEnd],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
              ),
              child: Center(
                child: Icon(module.icon, color: module.accentColor.withOpacity(0.5), size: 20),
              ),
            ),
          ],
        ),
